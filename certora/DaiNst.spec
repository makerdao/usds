...
hook Sstore nst.balanceOf[KEY address a] uint256 balance (uint256 old_balance) STORAGE {
...
hook Sstore dai.balanceOf[KEY address a] uint256 balance (uint256 old_balance) STORAGE {
